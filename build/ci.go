...
import (
	...
	"github.com/metanonia/go-metanonia/crypto/signify"
	"github.com/metanonia/go-metanonia/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/metanonia/go-metanonia/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/metanonia/go-metanonia/mobile")
