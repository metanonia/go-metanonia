...
import (
	...
	"github.com/metanonia/go-metanonia/signer/core"
)
...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain metanonia.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to metanonia-type signature.
		signature[64] -= 27 // Transform V from Metanonia-legacy to 0/1
	}
