...
func (mc *mockCaller) CallContract(ctx context.Context, call metanonia.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call metanonia.CallMsg) ([]byte, error) {
