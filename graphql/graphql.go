...
// Package graphql provides a GraphQL interface to Metanonia node data.
package graphql
...
// Account represents an Metanonia account at a particular block.
type Account struct {
...
// Transaction represents an Metanonia transaction.
...
// Block represents an Metanonia block.
...
type CallData struct {
	From     *common.Address // The Metanonia address the call is from.
	To       *common.Address // The Metanonia address the call is to.
...
type SyncState struct {
	progress metanonia.SyncProgress
}
